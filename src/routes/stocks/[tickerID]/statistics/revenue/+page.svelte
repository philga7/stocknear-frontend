        ...
        <div class="sm:pl-7 sm:pb-7 sm:pt-7 m-auto mt-2 sm:mt-0">
          ...
          {#if Object?.keys(data?.getHistoricalRevenue)?.length > 0}
            <div class="grid grid-cols-1 gap-2">
              ...
              <div
                class="history-driver mt-5 flex flex-col sm:flex-row items-start sm:items-center w-full justify-between sm:border-y border-gray-400 dark:border-gray-800 sm:pt-2 sm:pb-2"
              >

      ...
      <main class="w-full">
        <div class="sm:pl-7 sm:pt-7 sm:pb-7 m-auto mt-2 sm:mt-0">
          ...
          {#if rawData?.length !== 0 && rawData?.at(0)?.high !== undefined}
            ...
            >
              <div
                class="eps-beats-driver shadow-md bg-gray-100 dark:bg-gray-800/30 rounded p-4"
              >
              ...
              <div
                class="revenue-beats-driver shadow-md bg-gray-100 dark:bg-gray-800/30 rounded p-4"
              >
                <div class=" text-sm mb-2 flex items-center">
              ...
              <div
                class="avg-price-impact-driver shadow-md bg-gray-100 dark:bg-gray-800/30 rounded p-4"
              >
                <div class=" text-sm mb-2 flex items-center">
              ...
              <div
                class="volatility-impact-driver shadow-md bg-gray-100 dark:bg-gray-800/30 rounded p-4"
              >
                <div class=" text-sm mb-2 flex items-center">

...
<section class="w-full overflow-hidden m-auto">
  ...
  <div
    class="shadow-xs mb-4 flex flex-col divide-y divide-gray-300 dark:divide-gray-600 rounded-md border border-gray-400 dark:border-gray-600 sm:grid sm:grid-cols-3 sm:divide-x sm:divide-y-0"
  >

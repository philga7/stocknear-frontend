    ...
    <div class="sm:p-0 flex justify-center w-full m-auto overflow-hidden">
      ...
      >
                ...
                >
                  <DropdownMenu.Root>
                    <DropdownMenu.Trigger asChild let:builder>
                      <Button
                        builders={[builder]}
                        class="border-gray-400 dark:border-gray-600 border border-gray-400 shadow-xs sm:hover:bg-gray-100 dark:sm:hover:bg-primary ease-out flex flex-row justify-between items-center px-3 py-2  rounded-md truncate"
                      >
                  ...
                  <DropdownMenu.Root>
                    <DropdownMenu.Trigger asChild let:builder>
                      <Button
                        builders={[builder]}
                        class="border-gray-400 dark:border-gray-600 border bg-white dark:bg-default sm:hover:bg-gray-300 dark:sm:hover:bg-primary ease-out flex flex-row justify-between items-center px-3 py-2  rounded-md truncate"
                      >
                  ...
                  {#if filterList.length !== 0}
                    <Button
                      ...
                      class="w-fit border-gray-400 dark:border-gray-600 border shadow-xs bg-white dark:bg-default sm:hover:bg-gray-300 dark:sm:hover:bg-primary ease-out flex flex-row justify-start items-center px-3 py-2  rounded-md truncate"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <aside class="inline-block relative w-full lg:w-1/4 mt-3">
          <div
            class="w-full border border-gray-400 dark:border-gray-400 dark:border-gray-600 rounded-md h-fit pb-4 mt-4 cursor-pointer sm:hover:shadow-lg dark:sm:hover:bg-secondary transition ease-out duration-100"
          >
            <a

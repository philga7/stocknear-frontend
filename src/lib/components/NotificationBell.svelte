...
{#if data?.user}
  <a
    href="/notifications"
    on:click={toggle}
    class="bg-gray-100 shadow dark:bg-default text-gray-500 dark:text-gray-300 dark:sm:hover:text-white cursor-pointer sm:hover:bg-gray-200 dark:sm:hover:bg-[#18181B] relative border p-2 rounded-md border-gray-400 dark:border-gray-600 ml-3 -mr-1"
  >

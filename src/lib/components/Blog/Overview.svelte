...
<div class="mt-4">
  ...
  >
    <div class="flex flex-col">
      <div class="text-gray-500 dark:text-gray-300 text-sm">Market Cap</div>
    ...
    <div class="flex flex-col">
      <div class="text-gray-500 dark:text-gray-300 text-sm">EPS (TTM)</div>
      <div class="mt-0.5 text-lg bp:text-lg sm:mt-1.5 sm:text-xl font-semibold">
        {blogData?.epsTTM}
      </div>
    </div>
    <div class="flex flex-col">
      <div class="text-gray-500 dark:text-gray-300 text-sm">P/E (TTM)</div>
      <div class="mt-0.5 text-lg bp:text-lg sm:mt-1.5 sm:text-xl font-semibold">
        {blogData?.peTTM}
      </div>
    </div>
    ...
    <div class="flex flex-col">
      <div class="text-gray-500 dark:text-gray-300 text-sm">P/S</div>
      <div class="mt-0.5 text-lg bp:text-lg sm:mt-1.5 sm:text-xl font-semibold">
    ...
    <div class="flex flex-col">
      <div class="text-gray-500 dark:text-gray-300 text-sm">P/B</div>
      <div class="mt-0.5 text-lg bp:text-lg sm:mt-1.5 sm:text-xl font-semibold">
    ...
    <div class="flex flex-col">
      <div class="text-gray-500 dark:text-gray-300 text-sm">Next Earnings</div>
      <div class="mt-0.5 text-lg bp:text-lg sm:mt-1.5 sm:text-xl font-semibold">
    ...
    <div class="flex flex-col">
      <div class="text-gray-500 dark:text-gray-300 text-sm">Short % Float</div>
      <div class="mt-0.5 text-lg bp:text-lg sm:mt-1.5 sm:text-xl font-semibold">
        {blogData?.shortFloatPercent + "%"}
      </div>
    </div>
    <div class="flex flex-col">
      <div class="text-gray-500 dark:text-gray-300 text-sm">Short % Out</div>
      <div class="mt-0.5 text-lg bp:text-lg sm:mt-1.5 sm:text-xl font-semibold">
    ...
    <div class="flex flex-col">
      <div class="text-gray-500 dark:text-gray-300 text-sm">Forward P/E</div>
      <div class="mt-0.5 text-lg bp:text-lg sm:mt-1.5 sm:text-xl font-semibold">
        {blogData?.forwardPE}
      </div>
    </div>
